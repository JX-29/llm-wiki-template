...
2. Orient: read `SCHEMA.md` (resolve the layout — paths here assume the default dialect; substitute the resolved ones), `index.md`, and grep the wiki for the entities/concepts mentioned — don't create duplicates.
